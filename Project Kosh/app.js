...
const businessResRouter = require('./routes/businessRes');
const clientResRouter = require('./routes/clientRes');
...
app.use('/api/clientRes', clientResRouter);
app.use('/api/businessRes', businessResRouter);
